...
AFRAME.registerComponent('asyl-and-afd', {
  init: function () {
    ...
    d3.csv('data/asyl-and-afd.csv', rowConverter, function(data) {
      ...
      var minAfd = d3.min(data, function(d){ return d.afderststimme });
      var maxAfd = d3.max(data, function(d){ return d.afderststimme });
      ...
      var minAntraege = d3.min(data, function(d){ return d.antraegeRel });
      var maxAntraege = d3.max(data, function(d){ return d.antraegeRel });
      ...
      var minAbschiebungen = d3.min(data, function(d){ return d.abschiebungenRel })
      var maxAbschiebungen = d3.max(data, function(d){ return d.abschiebungenRel })
      ...
      countries
        .append('a-plane')
        .attrs({
          color: function(d){ return antraegeColorScale(d.antraegeRel)},
      ...
      countries
        .append('a-plane')
        .attrs({
          color: function(d){ return abschiebungenColorScale(d.abschiebungenRel)},
          position: '0 ' + -boxDimension/3 + ' 0',
          width: boxDimension,
          height: boxDimension/3
        });
